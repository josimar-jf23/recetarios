...
@section('title', 'Nueva Receta Tipo')
...
<div class="row justify-content-center">       
    <div class="card" style="width: 50em;">
        <card-header><h1>Nueva Receta Tipo</h1></card-header>
        <div class="card-body">
            <form method="POST" action="{{ route('admin.receta_tipos.store') }}" autocomplete="false">
