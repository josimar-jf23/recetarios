...
@section('title')
Nueva Indicacion de {{ ucwords($receta->nombre ) }}
@stop
...
<div class="row justify-content-center">       
    <div class="card" style="width: 50em;">
        <card-header><h1>Nueva Inidicacion de {{ ucwords($receta->nombre ) }}</h1></card-header>
        <div class="card-body">
            <form method="POST" action="{{ route('admin.receta_indicaciones.store') }}" autocomplete="false">
                ...
                <div class="form-group">
                    ...
                    <div class="col">
                        <input id="indicacion" type="text" class="form-control @error('indicacion') is-invalid @enderror" name="indicacion" value="{{ old('indicacion') }}" required>
                        @error('indicacion')
